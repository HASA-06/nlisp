...
router.get('/', (req, res) => {
    ...
    let bulletinBoardId = req.query.bulletinBoardId;
    ...
    let bulletinBoardsReadTask = [
        ...
        (connection, userId, callback) => {
            ...
            let getBulletinBoardDatasMoreQuery = mybatis.mappingSQLStatement('bulletin_boards', 'read_detail', 'getBulletinBoardDatasMore', getBulletinBoardDatasMoreParameter);
